//! The BIP39 English wordlist, as shipped by `@scure/bip39` 1.5.0 — the
...
//! trusted. Sorted, which the decoder relies on for a binary search; the same
//! test asserts the order.

/// The 2048 words, index = the 11-bit value each encodes.
